...
curl -X GET "https://app-backend.energiasolarcanarias.com/plant/benefits/2826461?proveedor=solaredgee" \
...
<script>
    function copiarCodigo() {
        const codigo = `curl -X GET "https://app-backend.energiasolarcanarias.com/plant/benefits/2826461?proveedor=solaredge" \
-H "Authorization: Bearer tu_token_de_acceso"`;
