...
curl -X GET "https://app-backend.energiasolarcanarias.com/usuarios/relacionar?idplanta=1851069&idusuario=20&proveedor=1" \
...
<script>
    function copiarCodigo() {
        const codigo = `curl -X GET "https://app-backend.energiasolarcanarias.com/usuarios/relacionar?idplanta=1851069&idusuario=20&proveedor=1" \\
-H "Authorization: Bearer tu_token_de_acceso"`;
